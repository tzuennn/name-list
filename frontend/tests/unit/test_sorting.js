...
describe('Sorting Utilities', function() {
  ...
  describe('sortByNameAZ', function() {
    it('should sort names alphabetically A→Z (case-insensitive)', function() {
      ...
      assert(names.indexOf('Bob') < names.indexOf('charlie'), 'Bob should come before charlie (case-insensitive)');
  ...
  describe('sortByNameZA', function() {
    it('should sort names alphabetically Z→A (reverse)', function() {
      ...
      assert(names.indexOf('zebra') < names.indexOf('Alice'), 'zebra should come before Alice in Z→A');
      assert(names.indexOf('charlie') < names.indexOf('Bob'), 'charlie should come before Bob in Z→A');
    });
  ...
  describe('sortByDateOldest', function() {
    ...
    it('should be reverse of newest first', function() {
      ...
      for (let i = 0; i < newest.length; i++) {
        ...
        assert.equal(newest[newestIndex].id, oldest[oldestIndex].id, 
  ...
  describe('Unicode and Locale Support', function() {
    ...
    it('should handle mixed case consistently', function() {
      ...
      assert(names.every(name => name === 'apple'), 'All variations should be equivalent when sorted');
    });
  });
